...
namespace SasTokenGenerator
{
    ...
    public static class SasTokenGenerator
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "{*segments}")]HttpRequestMessage req, TraceWriter log, ExecutionContext context)
        {
